...
import { IGamelogWithReverses, IViseurGamelog } from "src/viseur/game/gamelog";
...
export class PlaybackPane extends BaseElement {
     ...
     */
    private getNumberOfTurnsInGamelog(gamelog: Immutable<IGamelogWithReverses>): number {
        let turns = -1;
     ...
     */
    private updateTimepointsFromGamelog(gamelog: Immutable<IViseurGamelog>): void {
        this.numberOfDeltas = gamelog.deltas.length;
        this.numberOfTurns = this.getNumberOfTurnsInGamelog(gamelog);
    }
